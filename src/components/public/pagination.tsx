...
const linkStyles =
  "inline-flex min-h-11 items-center justify-center rounded-lg border border-line-strong bg-surface px-4 py-2 text-sm font-medium text-ink shadow-card transition hover:bg-sunken focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand-100";
